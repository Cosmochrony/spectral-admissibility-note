...
$\chi$ itself.
  ...
  \section{Constituent Papers}
    ...
    \subsection{O-series core: LPS phase (O1--O8)}
      ...
      \textbf{O1}~\cite{Beau2026a6} shows that this saturation is an artefact of holding the LPS
      parameter fixed: letting the valence grow contracts the Kesten--McKay support towards its
    ...
    \subsection{Numerical campaign and closure papers (O25--O33), with the companion notes}
      ...
      $q = 211$ and $0.7$ at $q = 307$: the test passes at all four.
      ...
      \begin{table}[ht]
        \centering
        \caption{Summary of the corpus by phase; the last two rows collect the constituents that
        section~\ref{sec:numerical} presents inside its own subsection.
