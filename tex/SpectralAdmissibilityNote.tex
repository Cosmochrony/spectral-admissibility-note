...
$\chi$ itself.
  ...
  \section{Constituent Papers}
    ...
    \subsection{Numerical campaign and closure papers (O25--O33), with the companion notes}
      ...
      $R \leq 3$, the normalised ratios are $R = 2.1$ at $q = 61$ (one triplet of four), $0.4$ at
      $q = 151$, $1.0$ at $q = 211$ and $0.7$ at $q = 307$, each of the last three on the single
      triplet tested: the test passes at all four primes.
  ...
  \section{Status of Results}
    ...
    \subsection{Numerical evidence}
      ...
      \begin{enumerate}
        ...
        the normalised ratio $R$ satisfies the criterion $R \leq 3$ at
        $q \in \{61, 151, 211, 307\}$, with values $2.1$, $0.4$, $1.0$ and $0.7$ against the
        noise floor $1.657 \times 10^{-3}$.
      \end{enumerate}
