...
$\chi$ itself.
  ...
  \section{Constituent Papers}
    ...
    \subsection{Numerical campaign and closure papers (O25--O33), with the companion notes}
      ...
      spectral pairs via binary-icosahedral representation, and formulates a hierarchy of
      identifications: growth equivalence at Level~I, quotient identification at Level~II, and the
      conditional canonical identification of the spin-$\tfrac{1}{2}$ sector at Level~III, for
      which its Test~4 states a falsifiability criterion.
      ...
      \begin{table}[ht]
        ...
        \begin{tabular}{@{}>{\raggedright\arraybackslash}p{2.7cm}
          ...
          \midrule
          Precursors & SpAdm, SpCap, SpGram, 3Gen & $Q_8 \subset 2I$; binary cover dominance at
            $d \in \{6, 12, 24\}$ & P/S \\
  ...
  \section{Outputs to Downstream Branches}
    ...
    \begin{table}[ht]
      ...
      \begin{tabular}{@{}>{\raggedright\arraybackslash}p{5.5cm}
        ...
        SU(3) co-admissible triplet, withdrawn in O31 & Q6a, Gauge note & O \\
  ...
  \section{Status of Results}
    ...
    \subsection{Structural results}
      ...
      \begin{enumerate}
        ...
        \item \textit{Observable-class identification} (O16~\cite{Beau2026a20}): under a
    ...
    \subsection{Open hypotheses}
      ...
      \begin{enumerate}
        ...
        breadth for $q \in \{29, 61, 101, 151, 211\}$, and O25 extends it to
