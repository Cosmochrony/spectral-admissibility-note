...
$\chi$ itself.
  ...
  \section{Logical Chain of the Sub-Programme}
    ...
    \begin{enumerate}
      ...
      proves Born--Infeld parity as an equivariant symmetry and states the fibre identification
  ...
  \approx 4.3$--$4.8$ for $q \in \{29, 53, 61\}$ ($R^2 > 0.98$).
    ...
    \subsection{Pair observable and transfer chain (O16--O24)}
      ...
      hypothesis: the action is even and parity is an equivariant symmetry (proved), an even
  ...
  \section{Status of Results}
    ...
    \subsection{Proved results}
      ...
      \begin{enumerate}
        ...
        \item \textit{Equivariant parity} (O18~\cite{Beau2026a22}): BI action evenness and
        probe-equivariant parity are proved; fixed-probe indiscernibility is refuted, and the
