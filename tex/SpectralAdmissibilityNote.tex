...
$\chi$ itself.
  ...
  \section{Constituent Papers}
    ...
    \subsection{O-series core: Heisenberg transition (O9--O15)}
      ...
      The corresponding Heisenberg Cayley graph has polynomial ball growth
    ...
    \subsection{Pair observable and transfer boundary (O16--O24)}
      ...
      $\nobs$ onto a BFS shell of the relevant Cayley graph.
      Shell alignment is a theorem, not an independent geometric hypothesis.
  ...
  \section{Status of Results}
    ...
    \subsection{Proved results}
      ...
      \begin{enumerate}
        \item \textit{Admissibility envelope.}\newline
        SpectralAdmissibility~\cite{Beau2026a1} proves that in the linearised regime
        ...
        \item \textit{Adjoint dimension} (O23~\cite{Beau2026a27}): for a supplied
