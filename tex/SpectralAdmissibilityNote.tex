...
$\chi$ itself.
  ...
  \section{Logical Chain of the Sub-Programme}
    ...
    \begin{enumerate}
      ...
      admissibility; $2I$ maximises the capacity functional at the verified valences
      $d \in \{6, 12, 24\}$, its maximality for general $d$ remaining a conjecture; the LPS family
      provides the Ramanujan approximation to $\SU(2)$ in the large-$q$ limit.
    \end{enumerate}
  ...
  \section{Constituent Papers}
    ...
    \subsection{Numerical campaign and closure papers (O25--O33), with the companion notes}
      ...
      conditional canonical identification of the spin-$\tfrac{1}{2}$ sector at Level~III, whose
      falsifiability criterion is its Test~4.
      ...
      One triplet at $q = 61$ gives a short profile that O32 records as a pipeline artefact and
      states does not affect the ratio, which is computed from all four.
  ...
  \section{Outputs to Downstream Branches}
    ...
    \begin{table}[ht]
      ...
      \begin{tabular}{@{}>{\raggedright\arraybackslash}p{5.5cm}
        ...
        Admissibility thread $Q_8 \subset 2I \subset \SU(2)$, maximality verified at
