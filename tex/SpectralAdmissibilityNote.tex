...
$\chi$ itself.
  ...
  \approx 4.3$--$4.8$ for $q \in \{29, 53, 61\}$ ($R^2 > 0.98$).
    ...
    \subsection{Pair observable and transfer chain (O16--O24)}
      ...
      The O15 bound is structurally informative: it points at the observable class rather than at
      a defect of the transfer mechanism.
    ...
    \subsection{Numerical campaign and closure papers (O25--O33), with the companion notes}
      ...
      \begin{table}[ht]
        ...
        \begin{tabular}{@{}lllll@{}}
          ...
          Mass architecture & O33 & Exact doublets and protected sectors & S \\
