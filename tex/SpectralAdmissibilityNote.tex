...
\begin{document}
  ...
  \begin{abstract}
    ...
    The answer organises the entire O-series (papers O1--O33 and five precursor papers)
  ...
  \section{Motivation and Central Question}
    ...
    that agreement is a coincidence check, making this sub-programme the primary quantitative
...
$\chi$ itself.
  ...
  \section{Constituent Papers}
    ...
    The sub-programme comprises five precursor papers, thirty-three O-series papers, and two
    companion notes.
  ...
  \approx 4.3$--$4.8$ for $q \in \{29, 53, 61\}$ ($R^2 > 0.98$).
    ...
    \subsection{Pair observable and transfer chain (O16--O24)}
      ...
      rather than a constructed transfer, and identifies the O15 obstruction as an
  ...
  \section{Inputs from Upstream Results}
    ...
    \begin{enumerate}
      ...
      $\Heis_3(\mathbb{Z}/q\mathbb{Z})$ and its Weil representation $V_\rho$, taken as a supplied
      carrier.
